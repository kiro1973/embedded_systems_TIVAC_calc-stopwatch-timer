...
void displayTime(int h,int m,int s,int ss)     // diplay time when we giv it the 4 values of hour minute seconds and millisonds
{
...
void loading(void)                      //display Loading on the screen
{
  LCD_command(DISPLAY_ON_CURSOR_OFF);
  for(int i = 9; i < 12; i++)
  {
